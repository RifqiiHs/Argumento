import mongoose, { type Document, type InferSchemaType, Schema, Types } from 'mongoose';
...
const UsersSchema: Schema = new Schema(
  {
    ...
    activeTheme: { type: String, default: 'theme_green' },
    ...
    verifyTokenGeneratedAt: { type: Date, default: null },
    verifyTokenExpiry: { type: Date, default: null },
    resetToken: { type: String, default: null },
    resetTokenGeneratedAt: { type: Date, default: null },
