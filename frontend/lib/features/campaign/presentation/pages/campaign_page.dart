                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      Expanded(child: Text(level.title, style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w600, color: isDone ? widget.accent : AppColors.textSecondary), overflow: TextOverflow.ellipsis)),
