                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text('Welcome back,',
                                      style: GoogleFonts.inter(fontSize: 10, color: AppColors.textMuted, fontWeight: FontWeight.w400),
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(isShiftDone ? Icons.check_circle_rounded : Icons.assignment_rounded, color: isShiftDone ? AppColors.textMuted : accent, size: 26),
          ),
        ],
      ),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.school_rounded, color: AppColors.info, size: 24),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text('Train without affecting your stats',
